...
class ReaperScythe extends \pocketmine\item\Sword implements \customiesdevs\customies\item\ItemComponents{
	...
	public function __construct(ItemIdentifier $identifier, string $name){
		...
		$this->initComponent("reaper_scythe", new CreativeInventoryInfo(CreativeInventoryInfo::CATEGORY_EQUIPMENT, CreativeInventoryInfo::GROUP_SWORD));
